    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-3xl bg-[#0d091f]/95 border border-violet-500/30 rounded-3xl p-6 shadow-[0_20px_60px_rgba(0,0,0,0.8)] backdrop-blur-2xl text-left my-8 overflow-hidden"
        ...
        >
          ...
          {/* HERO PROFILE HEADER */}
          <div className="p-6 rounded-2xl bg-gradient-to-r from-violet-950/60 via-purple-900/40 to-indigo-950/60 border border-violet-500/30 relative overflow-hidden mb-6 shadow-xl">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 relative z-10">
              ...
              <div className="relative flex-shrink-0">
                <img 
                  src={displayAvatar} 
                  alt={username} 
                  className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-4 border-violet-400/50 shadow-[0_0_25px_rgba(124,58,237,0.4)]"
                />
                <div className="absolute bottom-1 right-1 p-1.5 rounded-full bg-[#0d091f] border border-emerald-400 text-emerald-400 shadow-md" title="Public Identity Isolated">
                ...
                <div className="text-center sm:text-right w-full">
                  <div className="flex items-center justify-between sm:justify-end gap-2">
                    ...
                    <button
                      ...
                      className="px-2 py-0.5 rounded-lg bg-violet-600/30 hover:bg-violet-600/50 text-violet-300 text-[10px] font-bold border border-violet-400/30 flex items-center gap-1 cursor-pointer transition-all"
                    ...
                    <button
                      ...
                      className={`flex-1 sm:flex-none px-3 py-1.5 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer border ${
                        isFollowing
                          ...
                          : 'bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white border-violet-400/30 shadow-md'
                      }`}
                    >
          ...
          <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-1 custom-scrollbar">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2 sticky top-0 bg-[#0d091f]/95 py-2 z-10 border-b border-white/10">
            ...
            {userPosts.length > 0 ? (
              ...
              <div className="p-8 rounded-2xl bg-black/30 border border-white/10 text-center text-white/40">
                <Sparkles className="w-6 h-6 text-violet-400 mx-auto mb-2 opacity-60" />
